...
#pragma warning restore STR0010
    {
        ...
        if (match.Success)
        {
            ...
            repo = match.Groups[groupnum: 2].Value.Replace(".git", string.Empty);
            result = true;
        }
        ...
        var result = true switch
            {
                ...
                var _ when fileName.StartsWith("readme") => DocCategory.Overview,
    ...
    {
        bool result = fileName.StartsWith("changelog") ||
    ...
    {
        bool result = path.Contains("/samples/") ||
    ...
    {
        bool result = path.StartsWith("docs/") ||
                      path.StartsWith("doc/") ||
                      path.Contains("/docs/") ||
                      path.Contains("/doc/");
        return result;
