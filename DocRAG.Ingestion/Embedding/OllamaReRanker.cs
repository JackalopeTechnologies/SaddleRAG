...
public class OllamaReRanker : IReRanker
{
                                                             ...
                                                             CancellationToken ct)
    {
        ...
        promptBuilder.AppendLine("Rate how relevant each document is to the search query.");
        promptBuilder
            .AppendLine("For each document, reply with its number and ONE word: PERFECT, HIGH, MEDIUM, LOW, or NONE.");
        ...
        promptBuilder.AppendLine("Reply with ONLY one line per document in this exact format:");
        promptBuilder.AppendLine("1: MEDIUM");
        promptBuilder.AppendLine("2: HIGH");
        promptBuilder.AppendLine("etc.");
