// RescrubJobRepositoryDeleteTests.cs
...
///     <see cref="RescrubJobRepository" />. Mirrors the scrape and
///     background job repo tests so the safety guarantees hold for the
///     rescrub collection too.
/// </summary>
[Trait("Category", "Integration")]
public sealed class RescrubJobRepositoryDeleteTests
{
    public RescrubJobRepositoryDeleteTests()
    {
        ...
        mRepo = new RescrubJobRepository(mContext);
    }

    private readonly SaddleRagDbContext mContext;
    private readonly RescrubJobRepository mRepo;
    ...
    private static RescrubJobRecord MakeJob(ScrapeJobStatus status, string libraryId, string version) =>
