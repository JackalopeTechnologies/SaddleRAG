...
public static class UnitsLookup
{
    ...
    private static readonly HashSet<string> smUnits = new HashSet<string>(StringComparer.Ordinal)
                                                          {
                                                              // SI base units (case-sensitive — "M" is mega-prefix, "m" is meter)
                                                              "m", "g", "s", "A", "K", "mol", "cd",

                                                              // SI derived units
                                                              "Hz", "N", "Pa", "J", "W", "C", "V", "F", "S", "Wb", "T",
                                                              "H", "lm",
                                                              ...
                                                              "kOhm", "MOhm", "Ohm", "ohm", "ohms", "kΩ", "MΩ", "Ω",
                                                              "uS", "mS", "kS",
    ...
    /// </summary>
    private static readonly HashSet<string> smUnitsCaseInsensitive =
