...
public static class Stoplist
{
    ...
    public static StoplistMatch Match(string candidate, LibraryProfile profile)
    {
        ...
        var result = (inGlobal, inLibrary) switch
            {
                (true, var _) => StoplistMatch.Global,
    ...
    private static readonly HashSet<string> smStopwords = new HashSet<string>(StringComparer.OrdinalIgnoreCase)
                                                              {
                                                                  ...
                                                                  "what", "which",
                                                                  "who", "whom", "whose", "why", "how", "all", "any",
                                                                  "some", "not",
                                                                  "only", "own", "same", "so", "than", "too", "very",
                                                                  "just", "now", "also",
                                                                  "before", "after", "above", "below", "during", "each",
                                                                  "every", "both",
                                                                  "between", "among", "such", "more", "most", "less",
                                                                  "many", "much", "few",
                                                                  "another", "other", "others", "an", "you", "your",
                                                                  "yours", "we", "us",
                                                                  ...
                                                                  "represents", "returns", "values", "value", "use",
                                                                  "uses", "used", "using",
                                                                  "see", "note", "notes", "example", "examples",
                                                                  "default", "defaults",
                                                                  "type", "types", "name", "names", "list", "lists",
                                                                  "method", "methods",
                                                                  "function", "functions", "class", "classes",
                                                                  "interface", "interfaces",
                                                                  "object", "objects", "member", "members", "field",
                                                                  "fields", "property",
                                                                  "properties", "parameter", "parameters", "argument",
                                                                  "arguments", "result",
                                                                  "results", "output", "outputs", "input", "inputs",
                                                                  "true", "false", "null",
                                                                  "none", "undefined", "yes", "no", "warning",
                                                                  "warnings", "error", "errors",
                                                                  "exception", "exceptions", "available", "supports",
                                                                  "supported", "requires",
                                                                  "required", "optional", "deprecated", "obsolete",
                                                                  "internal", "private",
                                                                  "public", "protected", "static", "abstract",
                                                                  "virtual", "override", "sealed",
                                                                  "readonly", "lets", "let", "make", "makes", "set",
                                                                  "sets", "get", "gets",
