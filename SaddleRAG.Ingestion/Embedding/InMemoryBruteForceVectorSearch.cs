...

{
    ...
    private IEnumerable<KeyValuePair<string, List<DocChunk>>> ResolveTargetIndices(VectorSearchFilter filter,
    ...
    private IEnumerable<KeyValuePair<string, List<DocChunk>>> ResolveExactIndex(VectorSearchFilter filter,
        string profilePrefix)
