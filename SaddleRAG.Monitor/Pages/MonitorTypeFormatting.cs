...
{
    public static Color TypeColor(JobType type) => type switch
    {
    ...
    public static string TypeLabel(JobType type) => type switch
    {
    ...
    public static bool IsCrawlerJob(JobType type) => type is JobType.Scrape or JobType.DryRunScrape;
